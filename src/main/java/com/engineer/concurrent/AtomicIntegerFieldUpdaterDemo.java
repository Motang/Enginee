...
public class AtomicIntegerFieldUpdaterDemo {
	...
	void doit() {
		...
		System.out.println("1 ==> " + getUpdater("value1").getAndSet(data, 10) + " after to " + data.value1);
		System.out.println("2 ==> " + getUpdater("value2").incrementAndGet(data) + " after to " + data.value2);
		System.out.println("3 ==> " + getUpdater("value3").decrementAndGet(data) + " after to " + data.value3);
		System.out.println("true ==> " + getUpdater("value4").compareAndSet(data, 4, 5) + " after to " + data.value4);
	}
